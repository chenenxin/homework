...
with st.sidebar:
    ...
    if hanfu_df is not None:
        ...
        st.write("📂 汉服数据加载失败")
    st.markdown('<h4 style="font-size:18px;font-weight:normal;">马面裙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;圆领袍</h4>', unsafe_allow_html=True)
    st.markdown('<h4 style="font-size:18px;font-weight:normal;">曳撒&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;褙子</h4>', unsafe_allow_html=True)  
    st.markdown('<h4 style="font-size:18px;font-weight:normal;">袄裙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;直裾</h4>', unsafe_allow_html=True)  
    st.markdown('<h4 style="font-size:18px;font-weight:normal;">齐胸襦裙&nbsp;&nbsp;&nbsp;&nbsp;曲裾</h4>', unsafe_allow_html=True)  
    st.markdown('<h4 style="font-size:18px;font-weight:normal;">齐腰襦裙</h4>', unsafe_allow_html=True)      
