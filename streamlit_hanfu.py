...
with st.sidebar:
    ...
    st.markdown('<h4 style="font-size:18px;font-weight:normal;font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;曳撒&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;褙子</h4>', unsafe_allow_html=True)  
    st.markdown('<h4 style="font-size:18px;font-weight:normal;font-style: italic">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;袄裙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;直裾</h4>', unsafe_allow_html=True)  
